  ...
  <i-layout vertical>
    <i-layout-content
      ...
      ><i-form style="min-width: 1324px">
        <i-container style="min-height: 95vh; min-width: 1000px">
          <i-row>
            <i-form class="_margin-left:4"
              ><h2>Cadastro de Usuários</h2></i-form
            >
          </i-row>
          <i-container style="max-width: 1200px">
            <i-row style="max-width: 500px">
              <i-column sm="2" md="12">
        ...
        <div class="botoes">
          ...
          <i-button class="_margin-left:1 e-button" color="primary">Consultar</i-button>
        </div>
      </i-form>
    </i-layout-content>
  </i-layout>
